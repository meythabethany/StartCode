...
import id.sch.smktelkom_mlg.www.startcode.QuizLibrary.CssLibrary;
...
public class CssQuiz extends Fragment {
    private CssLibrary mCssLibrary = new CssLibrary();
    ...
    private void updateQuestion() {
        mQuestionView.setText(mCssLibrary.getQuestion(mQuestionNumber));
        mButtonChoice1.setText(mCssLibrary.getChoice1(mQuestionNumber));
        mButtonChoice2.setText(mCssLibrary.getChoice2(mQuestionNumber));
        mButtonChoice3.setText(mCssLibrary.getChoice3(mQuestionNumber));

        mAnswer = mCssLibrary.getCorrectAnswer(mQuestionNumber);
        mQuestionNumber++;
    }
