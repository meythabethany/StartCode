...
public class Laundry extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.laundry, null);
        return v;
    }

    public void open() {
        Intent codeIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/meythabthny/ProjectJavaFxLaundrydanATM"));
