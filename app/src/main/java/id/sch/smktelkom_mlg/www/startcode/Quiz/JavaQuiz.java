...
import id.sch.smktelkom_mlg.www.startcode.QuizLibrary.JavaLibrary;
...
public class JavaQuiz extends Fragment {
    ...
    private JavaLibrary mJavaLibrary = new JavaLibrary();
    ...
    private void updateQuestion() {
        mQuestionView.setText(mJavaLibrary.getQuestion(mQuestionNumber));
        mButtonChoice1.setText(mJavaLibrary.getChoice1(mQuestionNumber));
        mButtonChoice2.setText(mJavaLibrary.getChoice2(mQuestionNumber));
        mButtonChoice3.setText(mJavaLibrary.getChoice3(mQuestionNumber));

        mAnswer = mJavaLibrary.getCorrectAnswer(mQuestionNumber);
        mQuestionNumber++;
    }
